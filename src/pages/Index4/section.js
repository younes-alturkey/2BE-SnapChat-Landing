                ...
                <div className="display-table-cell">
                    <Container>
                        <Row className="vertical-content">
                            <Col lg={7} className="text-white text-left margin-t-30">
                                <h1 className="home-title">We help startups launch their products</h1>
                                <p className="padding-t-15 home-desc home-subtitle-width-100">Etiam sed.Interdum consequat proin vestibulum class at a euismod mus luctus quam.Lorem ipsum dolor sit amet, consectetur adipisicing eli.</p>
                                <Link to="#" className="btn btn-custom margin-t-30 waves-effect waves-light">Get Started <i className="mdi mdi-arrow-right"></i></Link>
                            </Col>
                            <Col lg={{size:4, offset:1}} className="margin-t-30">
                                <div className="home-registration-form bg-white">
                                    ...
                                    <Form className="registration-form" id="registration-form">
                                        ...
                                        <Button color="none" className="btn-custom home-btn-width waves-effect waves-light">Send Detail</Button>
                                    </Form>
                                </div>
                            </Col>
                        </Row>
